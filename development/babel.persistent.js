(function(){
	...
	class Persistent extends Proxy{
		constructor(){
			...
			super({}, {
				...
				deleteProperty(target, property){
					...
					if(_.isObject(value)){
						...
						objectMetaData.save();
					} else {									// It can be a child, function, object, or disowned property. Can clear it's cache key without consequence unless it's an object
	...
	function loadAll(){
		...
		_.forIn(model.data, (item, id) => {
			_.forIn(item.metaData.siblingProperties, (siblingId, property) => {
