//babel --watch util.cache.js6 --out-file persistent.js
...
//pObject : A persistent object, in that all it's properties that aren't other objects, listed in don't cache, or adopted point to the cache
